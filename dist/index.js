...
;(function (root, factory) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__nccwpck_require__(898));
	}
	else {}
...
;(function (root, factory, undef) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__nccwpck_require__(898), __nccwpck_require__(512), __nccwpck_require__(686));
	}
	else {}
}(this, function (CryptoJS) {
...
// EXTERNAL MODULE: ./node_modules/.pnpm/crypto-js@4.1.1/node_modules/crypto-js/hmac-sha256.js
var hmac_sha256 = __nccwpck_require__(203);
var hmac_sha256_default = /*#__PURE__*/__nccwpck_require__.n(hmac_sha256);
// EXTERNAL MODULE: ./node_modules/.pnpm/crypto-js@4.1.1/node_modules/crypto-js/enc-base64.js
var enc_base64 = __nccwpck_require__(281);
var enc_base64_default = /*#__PURE__*/__nccwpck_require__.n(enc_base64);
;// CONCATENATED MODULE: ./src/helper.ts

const parseBtns = (btns) => {
    if (btns.length == 0)
        return;
    let result = JSON.parse(btns);
    return result;
};
const parseLinks = (links) => {
    if (links.length == 0)
        return;
    let result = JSON.parse(links);
    return result;
};
const getBodyString = () => {
    const msgtype = (0,core.getInput)('msgType');
    let res = "";
    switch (msgtype) {
        case 'text':
            let textBody = {
                msgtype: 'text',
                text: {
                    content: (0,core.getInput)('content'),
                },
                at: {
        ...
        case 'link':
            let linkBody = {
                ...
                link: {
                    ...
                    picUrl: (0,core.getInput)('picUrl'),
                    messageUrl: (0,core.getInput)('messageUrl'),
                }
            };
        ...
        case 'actionCard':
            let actionCardBody = {
                ...
                actionCard: {
                    title: (0,core.getInput)('title'),
                    text: (0,core.getInput)('text'),
                    btnOrientation: (0,core.getInput)('btnOrientation'),
        ...
        case 'feedCard':
            let feedCardBody = {
                msgtype: 'feedCard',
                feedCard: {
                    links: parseLinks((0,core.getInput)('links')),
                }
            };
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const secret = (0,core.getInput)('secret');
    (0,core.info)(`accessToken: ${accessToken}`);
    (0,core.info)(`secret: ${secret}`);
    const timestamp = Date.now();
    let url = `https://oapi.dingtalk.com/robot/send?access_token=${accessToken}`;
    // 签名
    if (secret.length > 0) {
        const waitSignString = timestamp + "\n" + secret;
        const sign = enc_base64_default().stringify(hmac_sha256_default()(waitSignString, secret));
        (0,core.info)(`waitSignString ${waitSignString}`);
        (0,core.info)(`sign ${sign}`);
        url = `${url}&timestamp=${timestamp}&sign=${sign}`;
    }
    const resp = yield (yield fetch(url, {
        method: 'POST',
